...
namespace YKPortal.Controllers 
{
    public class SatinalmaTeklifiController : Controller
    {
        public ActionResult Sil(string Tip = "", string ID = "")
        {
            ...
            if (!YetkiKontrolu("/SatinalmaTeklifi/Liste", "Sil"))
            {
        ...
        public ActionResult Liste(string Tip = "", string AranacakKelime = "")
        {
            ...
            if (!YetkiKontrolu("/SatinalmaTeklifi/Liste", "Gor"))
            {
                return Redirect("~/YK/Anasayfa");
            }
            if (Tip == "")
        ...
        public ActionResult Detay(string Tip, string id = "")
        {
            ...
            if (!YetkiKontrolu("/SatinalmaTeklifi/Detay", "Gor"))
            {
                return Redirect("~/YK/Anasayfa");
            }
            SqlCommand cmd = new SqlCommand();
        ...
        public ActionResult Duzenle(string Tip, string id = "")
        {
            ...
            if (!YetkiKontrolu("/SatinalmaTeklifi/Detay", "Duzenle"))
            {
                return Redirect("~/YK/Anasayfa");
            }
            SqlCommand cmd = new SqlCommand();
