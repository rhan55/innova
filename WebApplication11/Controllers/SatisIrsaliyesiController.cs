...
namespace YKPortal.Controllers
{
    public class SatisIrsaliyesiController : Controller
    {
        ...
        public ActionResult Liste(BelgeDto belgeDto, string Tip = "", string AranacakKelime = "")
        {
            ...
            ViewBag.ControllerName = "SatisIrsaliyesi";
            ViewBag.Tip = Tip;
        ...
        public ActionResult Detay()
        {
            ...
            ViewBag.ControllerName = "SatisIrsaliyesi"; // Sayfaya özel controller adı
            ViewBag.IsDuzenleSayfasi = false;
            ViewBag.Tip = "SI"; // Sayfaya özel tip değeri
        ...
        public ActionResult PdfOlustur(string Tip, string id = "")
        {
            ...
            var uploadFolder = "SatisIrsaliyesi";
            var fileName = Guid.NewGuid().ToString() + "-Satis-Irsaliyesi.pdf";
