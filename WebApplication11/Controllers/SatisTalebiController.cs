...
{
    public class SatisTalebiController : Controller
    {
        public ActionResult Sil(string Tip = "", string ID = "")
        {
            ...
            if (!YetkiKontrolu("/SatisTalebi/Liste/?Tip=STL", "Sil"))
            {
        ...
        public ActionResult Liste(BelgeDto belgeDto, string Tip = "", string AranacakKelime = "")
        {
            ...
            if (!YetkiKontrolu("/SatisTalebi/Liste/?Tip=STL", "Gor"))
            {
                return Redirect("~/YK/Anasayfa");
            }
            ...
            {
                Belgeler = dt,
                Sil = YetkiKontrolu("/SatisTalebi/Liste/?Tip=STL", "Sil"),
        ...
        public ActionResult Detay()
        {
            ...
            if (!YetkiKontrolu("/SatisTalebi/Detay/?Tip=STL", "Gor"))
            {
                return Redirect("~/YK/Anasayfa");
            }
            ...
            ViewBag.ControllerName = "SatisTalebi"; // Sayfaya özel controller adı
            ViewBag.Tip = "STL"; // Sayfaya özel tip değeri
        ...
        public ActionResult Detay(string Tip, string id = "")
        {
            ...
            if (!YetkiKontrolu("/SatisTalebi/Detay/?Tip=STL", "Duzenle"))
            {
                return Redirect("~/YK/Anasayfa");
            }
        ...
        public ActionResult Duzenle(string Tip, string id = "")
        {
            ...
            ViewBag.Personeller = SatisPersoneliGetir();
            ViewBag.Duzenle = YetkiKontrolu("/SatisTalebi/Liste/?Tip=STL", "Duzenle");
            ViewBag.ControllerName = "SatisTalebi"; // Sayfaya özel controller adı
            ViewBag.Tip = "STL"; // Sayfaya özel tip değeri
        ...
        public ActionResult PdfOlustur(string Tip, string id = "")
        {
            ...
            var kaydedilecekYer = Server.MapPath("~/Uploads/Dosyalar/Teklifler/Satis-Talebi.pdf");
            ...
            return File(kaydedilecekYer, "application/pdf", "Satis-Talebi.pdf");
        }
