...
namespace YKPortal.Controllers
{
    public class SatisSiparisiController : Controller
    {
        public ActionResult Sil(string Tip = "", string ID = "")
        {
            ...
            if (!YetkiKontrolu("/SatisSiparisi/Liste/?Tip=SS", "Sil"))
            {
        ...
        public ActionResult Liste(BelgeDto belgeDto, string Tip = "", string AranacakKelime = "")
        {
            ...
            var yetkiUrl = "/SatisSiparisi/Liste/?Tip=SS";
            ...
            ViewBag.ControllerName = "SatisSiparisi";
            ViewBag.Tip = Tip;
        ...
        public ActionResult Detay()
        {
            ...
            ViewBag.ControllerName = "SatisSiparisi"; // Sayfaya özel controller adı
            ViewBag.IsDuzenleSayfasi = false;
            ViewBag.Tip = "SS"; // Sayfaya özel tip değeri
        ...
        public ActionResult Duzenle(string Tip, string id = "")
        {
            ...
            ViewBag.Personeller = SatisPersoneliGetir();
            ViewBag.Duzenle = YetkiKontrolu("/SatisSiparisi/Liste/?Tip=SS", "Duzenle");
            ViewBag.ControllerName = "SatisSiparisi"; // Sayfaya özel controller adı
            ViewBag.Tip = "SS"; // Sayfaya özel tip değeri
