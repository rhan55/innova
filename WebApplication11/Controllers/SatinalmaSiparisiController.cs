...
namespace YKPortal.Controllers
{
    public class SatinalmaSiparisiController : Controller
    {
        public ActionResult Sil(string Tip = "", string ID = "")
        {
            ...
            if (!YetkiKontrolu("/SatinalmaSiparisi/Liste", "Sil"))
            {
        ...
        public ActionResult Liste(string Tip = "", string AranacakKelime = "")
        {
            ...
            if (!YetkiKontrolu("/SatinalmaSiparisi/Liste", "Gor"))
            {
                return Redirect("~/YK/Anasayfa");
            }
        ...
        public ActionResult Detay(string Tip, string id = "")
        {
            ...
            if (!YetkiKontrolu("/SatinalmaSiparisi/Detay", "Gor"))
            {
                return Redirect("~/YK/Anasayfa");
            }
        ...
        public ActionResult Duzenle(string Tip, string id = "")
        {
            ...
            if (!YetkiKontrolu("/SatinalmaSiparisi/Detay", "Duzenle"))
            {
                return Redirect("~/YK/Anasayfa");
            }
            SqlCommand cmd = new SqlCommand();
