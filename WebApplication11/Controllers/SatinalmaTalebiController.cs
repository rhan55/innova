...
namespace YKPortal.Controllers
{
    public class SatinalmaTalebiController : Controller
    {
        ...
        public ActionResult Liste(BelgeDto belgeDto, string Tip = "", string AranacakKelime = "")
        {
            ...
            ViewBag.ControllerName = "SatinalmaTalebi";
            ViewBag.Tip = Tip;
        ...
        public ActionResult PdfOlustur(string Tip, string id = "")
        {
            ...
            var kaydedilecekYer = Server.MapPath("~/Uploads/Dosyalar/Teklifler/Satialma-Talebi.pdf");
            ...
            return File(kaydedilecekYer, "application/pdf", "Satinalma-Talebi.pdf");
        }
